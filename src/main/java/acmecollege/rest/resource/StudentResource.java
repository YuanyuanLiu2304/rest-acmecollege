...
public class StudentResource {
    ...
    @Path(RESOURCE_PATH_ID_PATH)
    @RolesAllowed({ADMIN_ROLE})
    public Response updatePersonById(@PathParam(RESOURCE_PATH_ID_ELEMENT) int id,Student studentWithUpdates) {
     
        Student newStudentWithIdTimestamps = service.updateStudentById(id,studentWithUpdates);
        // Build a SecurityUser linked to the new student
    ...
    public Response deletePersonById(@PathParam(RESOURCE_PATH_ID_ELEMENT) int id) {
        ...
        return Response.ok("student id " + id + " delete successfully").build();
    }
